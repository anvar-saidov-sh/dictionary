<x-layout>
    <div class="flex items-center justify-center min-h-screen bg-gray-100 px-4 sm:px-6 lg:px-8">
        <form method="POST" action="{{ route('register') }}"
            ...
            <button type="submit"
                    class="w-full bg-green-600 text-white py-2 sm:py-3 px-4 rounded-lg font-semibold
                           shadow-md hover:bg-green-700 hover:shadow-lg transition duration-200 ease-in-out
